const HowItWorks = () => {
  return (
    <section className="mt-50 bg-base-200 py-20 px-4 md:px-8 my-10">
      <div className="max-w-7xl mx-auto text-center">
   
        <h2
          className="text-4xl font-extrabold text-base-content mb-4 tracking-tight"
          data-aos="zoom-in"
        ...
        <p
          className="text-lg text-base-content/90 mb-16 max-w-3xl mx-auto"
          data-aos="fade-up"
          data-aos-delay="150"
          data-aos-duration="1200"
        >
        ...
        <div className="grid gap-10 md:grid-cols-3 text-left relative before:hidden md:before:block md:before:absolute md:before:top-1/4 md:before:left-0 md:before:right-0 md:before:h-1 before:bg-primary/20 before:z-0">
          ...
          <div
            className="flex flex-col items-start card bg-base-100 shadow-xl border border-base-300 transform transition duration-300 hover:scale-[1.02] hover:shadow-2xl z-10"
            data-aos="fade-right"
            data-aos-delay="200"
            data-aos-duration="1200"
          >
